  ...
  return (
    <div className="relative flex justify-center dashboard-bg -mt-5 sm:mt-0">
      <div className="w-[70%] mt-[4.4rem] md:w-[90%] md:mt-[4rem] sm:mt-[2rem] flex z-10 justify-between font-bold">
        ...
        <div
          className="mt-2 flex h-fit items-center"
          onClick={() => {
            toggleTheme();
        ...
        >
          ...
          <div
            className="w-12 h-6 ml-4 mr-4 py-3 px-1 bg-white rounded-xl flex items-center check"
            ref={themeToggler}
          >
            <div
              className="w-4 h-4 rounded-full check-toggle"
