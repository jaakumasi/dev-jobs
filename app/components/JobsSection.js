...
export default function JobsSection() {
  ...
  const EmptyMatchComponent = (
    <div
      className="w-[70%] md:w-[90%] py-5 rounded-lg text-center"
      style={{
  ...
  const LoadMoreBtn = showLoadMoreBtn ? (
    <div className="w-full flex justify-center -mt-10 mb-24 sm:mb-20">
      <button
        className="py-3 px-6 rounded-lg text-white font-bold focus:outline-none flex justify-center items-center search-btn"
